    ...
    return <>
        <section id="projects" className="py-[100px] max-lg:py-20 relative">
            <div className="container container-sm wrapper mx-auto relative">
                <Title className="mb-2 max-md:text-left max-md:ml-1 text-center [&_span]:text-4xl [&_.logo-icon]:scale-[200%]   [&_.logo-icon]:mr-6">{t("section_projects_title")}</Title>
                <p className="text-grey-50 max-md:text-left text-xl mb-14 max-md:mb-7 text-center">{t("section_projects_description")}</p>
                <div className="max-md:-mx-4 mb-5 flex flex-row items-center justify-start flex-wrap gap-y-12 max-lg:gap-y-6 max-lg:flex-wrap lg:[&_.project-teaser:nth-child(even)>div]:-order-1">
                    {
                        !allProjects ? null :
