...
export default function ProjectTeaser(props: ProjectTeaserProps) {
    return <>
        <div className="relative group w-1/2 mx-2 border-2 border-grey-400 rounded-md cursor-pointer hover:shadow-lg hover:shadow-white-100/20">
            <div className="absolute flex flex-col bottom-4 right-5 bg-black-300 rounded-sm px-3 py-2 border-2 border-grey-600 min-w-[250px] transition">
                <h4 className="text-[18px] font-normal flex items-center"> <span className="mr-2">{logoIcon}</span> {props.name}</h4>
